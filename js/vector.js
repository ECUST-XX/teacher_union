...
(function Victor() {
    ...
    //当前加载的script
    var container = script.getAttribute('container') || "head-bg";
    var anitOut = script.getAttribute('anitOut') || "output";
    var ambient = script.getAttribute('ambient') || "#002c4a";
    var diffuse = script.getAttribute('diffuse') || "#005584";
