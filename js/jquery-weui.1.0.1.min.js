...
function(t, e, n, i) {
    ...
    function $(t, e) {
        ...
        X.call(this, e)) : t & (It | Ht) && X.call(this, e)
    }
    function X(t) {
    ...
    c(F, C, {
        handler: function(t) {
            ...
            a & Pt && (0 === t.button || o) ? 0 > s && (e.push(t),
    ...
    c(et, tt, {
        ...
        directionTest: function(t) {
            var e = this.options
              ...
              , r = t.deltaX
              , o = t.deltaY;
            return a & e.direction || (e.direction & qt ? (a = 0 === r ? St : 0 > r ? Yt : Vt,
            n = r != this.pX,
            i = Math.abs(t.deltaX)) : (a = 0 === o ? St : 0 > o ? Nt : Ft,
            n = o != this.pY,
            i = Math.abs(t.deltaY))),
            t.direction = a,
...
+function(t) {
    ...
    e.prototype.touchMove = function(e) {
        if (!this.container.hasClass("refreshing")) {
            ...
            if (!(this.container.scrollTop() > 0)) {
                ...
                this.diffY < 0 || (this.container.addClass("touching"),
                e.preventDefault(),
                e.stopPropagation(),
                this.diffY = Math.pow(this.diffY, .8),
                this.container.css("transform", "translate3d(0, " + this.diffY + "px, 0)"),
                this.diffY < this.distance ? this.container.removeClass("pull-up").addClass("pull-down") : this.container.removeClass("pull-down").addClass("pull-up"))
            }
        }
    }
    ,
    e.prototype.touchEnd = function() {
        ...
        Math.abs(this.diffY) <= this.distance || (this.container.addClass("refreshing"),
    ...
    var e = function(e) {
        ...
        c.initPickerCol = function(e, n) {
            ...
            function o(e) {
                ...
                b = (new Date).getTime();
                var n, a;
                b - C > 300 ? a = E : (n = Math.abs(O / (b - P)),
                a = E + O * c.params.momentumRatio),
    ...
    var e, n = !1, i = function(t, e) {
        ...
        p.initCalendarEvents = function() {
            ...
            function a(t) {
                return o && s ? (o = s = !1,
                m = (new Date).getTime(),
                300 > m - f ? Math.abs(k) < 10 ? p.resetMonth() : k >= 10 ? n ? p.nextMonth() : p.prevMonth() : n ? p.prevMonth() : p.nextMonth() : -.5 >= T ? n ? p.prevMonth() : p.nextMonth() : T >= .5 ? n ? p.nextMonth() : p.prevMonth() : p.resetMonth(),
        ...
        p.monthHTML = function(t, e) {
            ...
            for (c = 1; h >= c; c++) {
                ...
                for (l = 1; d >= l; l++) {
                    ...
                    s = new Date(0 > i - 1 ? n - 1 : n,0 > i - 1 ? 11 : i - 1,k).getTime()) : (k += 1,
                    k > r ? (k -= r,
        ...
        ,
        p.close = function() {
            return p.opened && !p.inline ? (p.animating = !1,
            o() ? void t.closePicker(p.popover) : void t.closePicker(p.container)) : void 0
        }
        ,
        p.destroy = function() {
            p.close(),
